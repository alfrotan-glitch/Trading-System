# Experiment Ledger
**Trials:** 113 (all materially tested variants, not only winners, discarded counts)
...
- Trial count feeds DSR/multiple-testing correction (DSR 0.00 with N=113)
- No manual adjustment of trial count
- Ledger DB: data/sqlite/qts.db experiments table

Current ledger count: 113
