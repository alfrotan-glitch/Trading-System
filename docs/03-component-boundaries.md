...
class ExecutionEngine(Protocol):
    def submit_intent(self, intent: OrderIntent) -> RiskDecision: ...  # risk gate inside
    def on_tick(self, tick: Tick): ...
    def on_bar(self, bar: Bar): ...
    def reconcile(self) -> ReconcileReport: ...

class RiskEngine(Protocol):
    def pre_trade(self, intent: OrderIntent, ctx: RiskContext) -> RiskDecision: ...  # allow / veto / resize
