...
SAFETY_BOUNDARY = {
    ...
    "DEMO_EXECUTION": "AUTHORIZED for DEMO only (owner authorization artifact, hashed and revocable) — staged arming + pinned broker identity + registered diagnostic policy + the fail-closed pre-trade gate per order; never LIVE, never real capital",
