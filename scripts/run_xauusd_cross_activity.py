#!/usr/bin/env python
"""Runner for H-XF-02 volatility × activity magnitude on verifiable Discovery view."""
...
def main(argv=None) -> int:
    ...
    result = evaluate_cross_activity(scan, complete_rows=DISCOVERY_ROWS)
    ...
    print(json.dumps({"discovery_rows": scan.rows, "status": result["hypotheses"]["H-XF-02"]["status"]}))
    return 0
